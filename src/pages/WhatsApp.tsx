  ...
  const [conversations] = useState([
    {
      id: '1',
      companyId: '1',
      lastMessage: 'Olá! Gostaria de saber mais sobre nossos serviços.',
  ...
  const [messages] = useState([
    {
      id: '1',
      conversationId: '1',
      content: 'Olá! Gostaria de saber mais sobre nossos serviços.',
    ...
    },
    {
      id: '2',
      conversationId: '1',
      content: 'Olá! Claro, ficarei feliz em ajudar. Qual seria sua principal necessidade?',
  ...
  const [templates] = useState([
    {
      id: '1',
      name: 'Boas-vindas',
      message: 'Olá {nome}! Seja bem-vindo à VB Solution. Como podemos ajudá-lo hoje?',
      stage: 'contato-inicial'
    },
    {
      id: '2',
      name: 'Follow-up Proposta',
      message: 'Olá {nome}! Já teve tempo de analisar nossa proposta? Estou à disposição para esclarecer dúvidas.',
      stage: 'proposta'
    },
    {
      id: '3',
      name: 'Agendamento Reunião',
      message: 'Olá {nome}! Que tal agendarmos uma reunião para conversarmos melhor sobre sua necessidade?',
      stage: 'qualificacao'
    }
  ]);
