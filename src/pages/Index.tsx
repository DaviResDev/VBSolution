...
export default function Index() {
  ...
  const getRecentActivities = () => {
    const recentActivities = vbState.activities
    ...
    switch (cardType) {
            ...
            {getRecentActivities().map((activity, index) => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-500 text-xs">• {getStatusText(activity.status)}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <>
            <div className="flex items-center justify-between mb-4">
              ...
              <Button 
                variant="outline" 
                size="sm" 
                className="border-gray-300 text-gray-700 hover:bg-gray-50 px-3 py-1 text-sm flex items-center gap-2"
                onClick={goToToday}
              >
            ...
            <div className="text-center">
              <Button 
                className="bg-[#38424f] hover:bg-[#2a3138] text-white px-4 py-2 rounded-lg flex items-center gap-2 mx-auto"
      ...
      case 'pendentes':
        return (
          <div className="space-y-3">
            {vbState.activities
              .filter(activity => !activity.archived && activity.status === 'pending')
              .slice(0, 3)
              .map((activity) => (
                <div 
                  key={activity.id} 
            ...
            {vbState.activities.filter(activity => !activity.archived && activity.status === 'pending').length === 0 && (
              <div className="text-center py-8">
                ...
                <Button className="bg-[#38424f] hover:bg-[#2a3138] text-white px-4 py-2 rounded-lg flex items-center gap-2 mx-auto">
                  <Plus className="h-4 w-4" />
                  + Adicionar atividade
                </Button>
              </div>
          ...
          <div className="space-y-3">
            {getPrioritiesData().map((activity) => (
              ...
              >
                ...
                <div className="flex-1">
                  <p className="text-gray-900 text-sm font-medium">{activity.title}</p>
                  <p className="text-red-500 text-xs">• Prioridade Alta • {new Date(activity.date).toLocaleDateString('pt-BR')}</p>
                </div>
              </div>
            ))}
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6">
          ...
          <Button 
            className="bg-[#38424f] hover:bg-[#2a3138] text-white px-4 py-2 rounded-lg flex items-center gap-2"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {dashboardCards.filter(card => card.visible).map((card) => (
              <div 
                key={card.id}
                className={`bg-white rounded-2xl p-6 shadow-sm border border-gray-100 transform transition-all duration-300 hover:scale-105 hover:shadow-xl hover:-translate-y-2 cursor-pointer relative group ${
            ...
            <div className="space-y-6">
              ...
              {modalType === 'activity' && (
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <Button onClick={() => navigate(`/activities/${selectedItem.id}`)} className="bg-[#38424f] hover:bg-[#2a3138]">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <div className="flex items-center gap-2 text-sm text-gray-600">
                        <Calendar className="h-4 w-4" />
                        <span>Criado: {new Date(selectedItem.createdAt).toLocaleDateString('pt-BR')}</span>
                      </div>
                      <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  <div className="flex gap-2">
                    <Button onClick={() => navigate(`/projects/${selectedItem.id}`)} className="bg-[#38424f] hover:bg-[#2a3138]">
              ...
              {modalType === 'workgroup' && (
                <div className="space-y-4">
                      ...
                      {selectedItem.membersList?.map((member: any) => (
                        <div key={member.id} className="flex items-center gap-3 p-2 bg-gray-50 rounded-lg">
                          <Avatar className="h-8 w-8">
                            <AvatarFallback className="text-xs bg-[#38424f] text-white">
                              {member.initials}
                            </AvatarFallback>
                          </Avatar>
                          <div>
                  ...
                  <div className="flex gap-2">
                    <Button onClick={() => navigate(`/work-groups/${selectedItem.id}`)} className="bg-[#38424f] hover:bg-[#2a3138]">
              ...
              {modalType === 'calendar' && (
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <Button onClick={() => navigate('/calendar')} className="bg-[#38424f] hover:bg-[#2a3138]">
                      Ver no Calendário
                    </Button>
                    <Button variant="outline" onClick={() => setIsModalOpen(false)}>
                      Fechar
